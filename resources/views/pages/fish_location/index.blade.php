                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" name="location_modifier" step="1" min="0" max="99999" id="location_modifier" placeholder="Location Modifier" value="0" oninput="if(this.value > 99999) this.value = 99999; if(this.value < 1) this.value = 0;"/>
                        </div>
                        <div class="col-lg-12 col-md-12 mb-3">
                            <label class="form-label" for="location_mutation">Mutation Chance</label>
                            <input type="number" class="form-control" name="location_mutation" step="1" min="0" max="100" id="location_mutation" placeholder="Location Chance" value="0" oninput="if(this.value > 100) this.value = 100; if(this.value < 1) this.value = 0;"/>
                        </div>
                    </div>
                </div>
