                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" name="weather_modifier" step="1" min="0" max="99999" id="weather_modifier" placeholder="Weather Modifier" oninput="if(this.value > 99999) this.value = 99999; if(this.value < 1) this.value = 0;"/>
                        </div>
                    </div>
                </div>
