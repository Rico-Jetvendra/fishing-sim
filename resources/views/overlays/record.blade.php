        ...
        <div class="empty-record" id="empty-record" style="{{ $heaviest ? 'display:none;' : 'display:grid' }}">
            <div class="empty-content">
                ...
                <div class="empty-text">
                    Be the first to make history, today!
                </div>
